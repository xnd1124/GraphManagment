...
// Параметры:
//  ТипОформления - СправочникССылка.граф_ШаблоныЭлементов - элемент для которого нужно получить описание
...
// Параметры:
//  ЭлементыГрафов - Массив из СправочникСсылка.граф_ШаблоныЭлементов 
// Возвращаемое значение:
...
Функция ОписанияРасширенныхТипов(Типы)
	...
	|ИЗ
	|	Справочник.граф_ШаблоныЭлементов КАК граф_ТипыОформленийЭлементовГрафов
	|ГДЕ
...
Функция ЕстьПредопределенныеЭлементыБезТипа()
	...
	|	ИСТИНА
	|ИЗ
	|	Справочник.граф_ШаблоныЭлементов КАК граф_ТипыЭлементовГрафов
	|ГДЕ
