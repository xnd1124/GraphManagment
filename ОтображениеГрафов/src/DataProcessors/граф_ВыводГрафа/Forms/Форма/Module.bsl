...
Процедура Сохранить(Команда)
	...
	ОписаниеТипа = Новый ОписаниеТипов("СправочникССылка.граф_СохраненныеГрафы");
	ПоказатьВводЗначения(Оповещение, Неопределено, "Выберите из элементов сохраненных графов", ОписаниеТипа);
КонецПроцедуры
...
Процедура Восстановить(Команда)
	...
	ОписаниеТипа = Новый ОписаниеТипов("СправочникССылка.граф_СохраненныеГрафы");
	ПоказатьВводЗначения(Оповещение, Неопределено, , ОписаниеТипа);
КонецПроцедуры
