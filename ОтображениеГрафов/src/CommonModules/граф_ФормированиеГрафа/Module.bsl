...
Процедура ДобавитьСвязь(ПараметрыФормирования, Строка, ДанныеРезультата)
	...
	НоваяСтрока.Оформление = ОформлениеСвязи(ПараметрыФормирования, СтрокаСвязи.Оформление, Строка);
...
Функция ОформлениеСвязи(ПараметрыФормирования, ЗначениеОформления, Строка)
