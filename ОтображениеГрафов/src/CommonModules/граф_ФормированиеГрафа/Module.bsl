...
Функция ОформлениеСтроки(ПараметрыФормирования, ЗначениеОформления, Строка)
	Если ТипЗнч(ЗначениеОформления) =  Тип("СправочникСсылка.граф_ОформленияЭлементовГрафа") Тогда
	...
	Если НайденноеЗначение = Неопределено Тогда
		НайденноеЗначение = Справочники.граф_ОформленияЭлементовГрафа.НайтиПоНаименованию(ИмяОформления);
